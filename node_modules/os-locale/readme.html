...
<body>
<h1 id="os-locale-build-status">os-locale <a href="https://travis-ci.org/sindresorhus/os-locale"><img src="https://travis-ci.org/sindresorhus/os-locale.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
...
<pre><code>$ npm install os-locale</code></pre>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">const</span> osLocale <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;os-locale&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb3-2" title="2"></a>
<a class="sourceLine" id="cb3-3" title="3">(<span class="kw">async</span> () <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb3-4" title="4">    <span class="va">console</span>.<span class="at">log</span>(<span class="cf">await</span> <span class="at">osLocale</span>())<span class="op">;</span></a>
<a class="sourceLine" id="cb3-5" title="5">    <span class="co">//=&gt; &#39;en_US&#39;</span></a>
<a class="sourceLine" id="cb3-6" title="6"><span class="op">}</span>)()<span class="op">;</span></a></code></pre></div>
<h2 id="api">API</h2>
<h3 id="oslocaleoptions">osLocale(<a href="#options">options</a>)</h3>
<p>Returns a <code>Promise</code> for the locale.</p>
<h3 id="oslocale.syncoptions">osLocale.sync(<a href="#options">options</a>)</h3>
