...
<a class="sourceLine" id="cb2-2" title="2"><span class="kw">var</span> arr <span class="op">=</span> [<span class="dv">1</span><span class="op">,</span> <span class="dv">1</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">2</span><span class="op">,</span> <span class="dv">3</span><span class="op">,</span> <span class="dv">5</span>]</a>
<a class="sourceLine" id="cb2-3" title="3"></a>
<a class="sourceLine" id="cb2-4" title="4"><span class="at">require</span>(<span class="st">&quot;uniq&quot;</span>)(arr)</a>
<a class="sourceLine" id="cb2-5" title="5"><span class="va">console</span>.<span class="at">log</span>(arr)</a>
<a class="sourceLine" id="cb2-6" title="6"></a>
<a class="sourceLine" id="cb2-7" title="7"><span class="co">//Prints:</span></a>
<a class="sourceLine" id="cb2-8" title="8"><span class="co">//</span></a>
<a class="sourceLine" id="cb2-9" title="9"><span class="co">//  1,2,3,5</span></a>
...
<h2 id="why-use-this-instead-of-underscore.unique">Why use this instead of underscore.uniq[ue]?</h2>
<p>A few reasons:</p>
<ul>
...
<ol start="3" type="a">
<li>2013 Mikola Lysenko. MIT License</li>
</ol>
</body>
</html>
