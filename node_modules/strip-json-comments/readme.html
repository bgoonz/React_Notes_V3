...
<body>
<h1 id="strip-json-comments-build-status">strip-json-comments <a href="https://travis-ci.org/sindresorhus/strip-json-comments"><img src="https://travis-ci.org/sindresorhus/strip-json-comments.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
...
<a class="sourceLine" id="cb1-2" title="2">    <span class="co">// rainbows</span></a>
<a class="sourceLine" id="cb1-3" title="3">    <span class="st">&quot;unicorn&quot;</span><span class="op">:</span> <span class="co">/* ❤ */</span> <span class="st">&quot;cake&quot;</span></a>
...
<pre><code>$ npm install --save strip-json-comments</code></pre>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">const</span> json <span class="op">=</span> <span class="st">&#39;{/*rainbows*/&quot;unicorn&quot;:&quot;cake&quot;}&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb3-2" title="2"></a>
<a class="sourceLine" id="cb3-3" title="3"><span class="va">JSON</span>.<span class="at">parse</span>(<span class="at">stripJsonComments</span>(json))<span class="op">;</span></a>
<a class="sourceLine" id="cb3-4" title="4"><span class="co">//=&gt; {unicorn: &#39;cake&#39;}</span></a></code></pre></div>
<h2 id="api">API</h2>
<h3 id="stripjsoncommentsinput-options">stripJsonComments(input, <a href="#options">options</a>)</h3>
