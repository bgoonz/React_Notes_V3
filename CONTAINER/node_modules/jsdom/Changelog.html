...
<li>Improved MIME type and data: URL parsing throughout jsdom, by using the new <a href="https://www.npmjs.com/package/whatwg-mimetype"><code>whatwg-mimetype</code></a> and <a href="https://www.npmjs.com/package/data-urls"><code>data-urls</code></a> packages.</li>
<li>Removed some unnecessary <code>.webidl</code> files that were included in the npm package.</li>
</ul>
<h2 id="section-6">11.6.2</h2>
<ul>
<li>Fixed another regression (since v11.6.0) in <code>&lt;style&gt;</code> elements, where they would omit a series of parsing <code>"jsdomError"</code>s for any style sheet text containing spaces.</li>
...
<p>Another regression remains where we are emitting spurious CSS-parsing <code>"jsdomError"</code> events; see <a href="https://github.com/tmpvar/jsdom/issues/2123">#2123</a>. We also discovered a large amount of preexisting brokenness around <code>&lt;style&gt;</code>, <code>&lt;link&gt;</code>, and <code>@import</code>; see <a href="https://github.com/tmpvar/jsdom/issues/2124">#2124</a> for more details.</p>
<p>We’ll try to fix these soon, especially the regression.</p>
<h2 id="section-8">11.6.0</h2>
<ul>
<li>Added a fully-functioning <code>WebSocket</code> implementation!</li>
<li>Added a <code>window.performance</code> implementation, including the basics of the <a href="https://w3c.github.io/hr-time/">High Resolution Time</a> specification: <code>performance.now()</code>, <code>performance.timeOrigin</code>, and <code>performance.toJSON()</code>.</li>
...
<li>Fixed all URL-accepting properties to properly perform <a href="https://infra.spec.whatwg.org/#javascript-string-convert">scalar value string conversion</a> and URL resolution.</li>
<li>Fixed many other small edge-case conformance issues in the API surface of various web APIs; see <a href="https://github.com/tmpvar/jsdom/pull/2053">#2053</a> and <a href="https://github.com/tmpvar/jsdom/pull/2081">#2081</a> for more information.</li>
...
<h2 id="section-10">11.4.0</h2>
<p>For this release we’d like to welcome <span class="citation" data-cites="Zirro">[@Zirro]</span>(https://github.com/tmpvar/jsdom/commits?author=Zirro) to the core team; his contributions over the course of this year have enhanced jsdom immensely.</p>
<ul>
...
<li>Removed the <code>&lt;applet&gt;</code> element, <a href="https://github.com/whatwg/html/pull/1399">following the spec</a>.</li>
</ul>
<h2 id="section-11">11.3.0</h2>
<p>For this release we’d like to formally welcome <span class="citation" data-cites="TimothyGu">[@TimothyGu]</span>(https://github.com/tmpvar/jsdom/commits?author=TimothyGu) to the core team, as a prolific contributor. He will join the illustrious ranks of those who do so much work on jsdom that we no longer note their names in the changelog.</p>
<ul>
...
<p>This infrastructure will allow us to improve and implement many other similar behaviors; that work is being tracked in <a href="https://github.com/tmpvar/jsdom/issues/1129">#1129</a>.</p>
...
<li>Updated the interaction between a <code>&lt;textarea&gt;</code>’s <code>value</code>, <code>defaultValue</code>, and <code>textContent</code> per <a href="https://github.com/whatwg/html/commit/5afbba1cf62ee01bc6af3fd220d01f3f7591a0fc">a recent spec change</a></li>
...
<h2 id="section-14">11.0.0</h2>
<p>Breaking changes:</p>
<ul>
<li>Custom parsers, via the <code>parser</code> option to the old API, can no longer be specified. They were never tested, often broken, and a maintenance burden. The defaults, of <a href="https://www.npmjs.com/package/parse5">parse5</a> for HTML and <a href="https://www.npmjs.com/package/sax">sax</a> for XML, now always apply.</li>
...
<li><strong>Changed the <code>omitJsdomErrors</code> option to <code>omitJSDOMErrors</code></strong>, for consistency <a href="https://w3ctag.github.io/design-principles/#casing-rules">with web platform APIs</a>.</li>
...
<h2 id="section-22">9.8.3</h2>
<ul>
<li>Fixed syntax errors in Node.js v4.</li>
</ul>
<h2 id="section-23">9.8.2</h2>
<ul>
...
<h2 id="section-61">7.0.0</h2>
<p>This major release has as its headlining feature a completely re-written <code>XMLHttpRequest</code> implementation, in a heroic effort by <span class="citation" data-cites="nicolashenry">[@nicolashenry]</span>(https://github.com/nicolashenry). It includes a number of other smaller improvements and fixes. The breaking changes are highlighted in bold below.</p>
<ul>
...
<li>The interfaces for <code>HTMLAnchorElement.prototype</code> and <code>document.location</code> (as well as <code>URL</code>, of course) are now uniformized to follow the <a href="https://url.spec.whatwg.org/#api"><code>URLUtils</code> API</a> (minus <code>searchParams</code> for now).</li>
...
<h2 id="section-78">5.2.0</h2>
<ul>
<li>Implemented much of the <a href="https://dom.spec.whatwg.org/#interface-parentnode"><code>ParentNode</code></a> mixin (Joris-van-der-Wel):
<ul>
...
<h2 id="section-81">5.0.0</h2>
<p>This release overhauls how cookies are handled in jsdom to be less fiddly and more like-a-browser. The work for this was done by <span class="citation" data-cites="inikulin">[@inikulin]</span>(https://github.com/inikulin), who is also our beloved parse5 maintainer.</p>
...
<p>Finally, it’s worth noting that we now delegate our cookie handling in general to the <a href="https://www.npmjs.com/package/tough-cookie">tough-cookie</a> package, which should hopefully mean that it now captures many of the behaviors that were previously missing (for example <a href="https://github.com/tmpvar/jsdom/issues/1027">#1027</a>). <span class="citation" data-cites="inikulin">@inikulin</span> is working on <a href="https://github.com/goinstant/tough-cookie/pull/30">a large pull request to fix tough-cookie to be more spec compliant</a>, which should automatically be picked up by jsdom installs once it is merged.</p>
<h2 id="section-82">4.5.1</h2>
<ul>
<li>Removed unnecessary browserify dependency that was erroneously included in 4.5.0.</li>
</ul>
<h2 id="section-83">4.5.0</h2>
<ul>
<li>Added <code>document.currentScript</code>. (jeffcarp)</li>
</ul>
<h2 id="section-84">4.4.0</h2>
<ul>
...
<p>This release owes a special thanks to <span class="citation" data-cites="Sebmaster">[@Sebmaster]</span>(https://github.com/Sebmaster), for his amazing work taking on some of the hardest problems in jsdom and solving them with gusto.</p>
...
<li><code>jsdom.jQueryify</code> now requires a jQuery URL, since <a href="http://blog.jquery.com/2014/07/03/dont-use-jquery-latest-js/">always picking the latest was a bad idea</a>.</li>
</ul>
...
<li>Add: support for running the tests using <span class="citation" data-cites="aredridel">@aredridel</span>’s <a href="https://npmjs.org/package/html5">html5</a> parser, as a prelude toward maybe eventually making this the default and fixing various parsing bugs.</li>
</ul>
<h2 id="hotfix-2">0.3.1 (hotfix)</h2>
<ul>
<li>Fix: crashes when invalid selectors were present in stylesheets.</li>
</ul>
<h2 id="section-158">0.3.0</h2>
<ul>
...
<h2 id="hotfix-3">0.2.17 (hotfix)</h2>
<ul>
...
<li>Use instead of during serialization</li>
