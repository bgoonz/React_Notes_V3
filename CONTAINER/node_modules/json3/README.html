...
<body>
<h1 id="unmaintained">🚨 Unmaintained 🚨</h1>
<p class="banner">
JSON 3 is <strong>deprecated</strong> and <strong>no longer maintained</strong>. Please don’t use it in new projects, and migrate existing projects to use the native <code>JSON.parse</code> and <code>JSON.stringify</code> instead.
</p>
