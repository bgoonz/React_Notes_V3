...
<body>
<h1 id="path-exists-build-status">path-exists <a href="https://travis-ci.org/sindresorhus/path-exists"><img src="https://travis-ci.org/sindresorhus/path-exists.svg?branch=master" alt="Build Status" /></a></h1>
<blockquote>
...
<pre><code>$ npm install --save path-exists</code></pre>
...
<a class="sourceLine" id="cb2-2" title="2"><span class="kw">var</span> pathExists <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;path-exists&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-3" title="3"></a>
<a class="sourceLine" id="cb2-4" title="4"><span class="at">pathExists</span>(<span class="st">&#39;foo.js&#39;</span>).<span class="at">then</span>(<span class="kw">function</span> (exists) <span class="op">{</span></a>
<a class="sourceLine" id="cb2-5" title="5">    <span class="va">console</span>.<span class="at">log</span>(exists)<span class="op">;</span></a>
