...
<pre><code>$ npm install --save ansi-styles</code></pre>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> ansi <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;ansi-styles&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-2" title="2"></a>
<a class="sourceLine" id="cb2-3" title="3"><span class="va">console</span>.<span class="at">log</span>(<span class="va">ansi</span>.<span class="va">green</span>.<span class="at">open</span> <span class="op">+</span> <span class="st">&#39;Hello world!&#39;</span> <span class="op">+</span> <span class="va">ansi</span>.<span class="va">green</span>.<span class="at">close</span>)<span class="op">;</span></a></code></pre></div>
<h2 id="api">API</h2>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="va">console</span>.<span class="at">log</span>(<span class="va">ansi</span>.<span class="va">colors</span>.<span class="va">green</span>.<span class="at">open</span>)<span class="op">;</span></a></code></pre></div>
