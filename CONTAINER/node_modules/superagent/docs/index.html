...
<pre><code>  request.post(&#39;/user&#39;)
    ...
    .send({ pet: &#39;tobi&#39; })
    .then(callback, errorCallback)</code></pre>
<p>By default sending strings will set the <code>Content-Type</code> to <code>application/x-www-form-urlencoded</code>, multiple calls will be concatenated with <code>&amp;</code>, here resulting in <code>name=tj&amp;pet=tobi</code>:</p>
<pre><code>  request.post(&#39;/user&#39;)
    .send(&#39;name=tj&#39;)
    .send(&#39;pet=tobi&#39;)
    .then(callback, errorCallback);</code></pre>
...
<p>As a short-hand the <code>.type()</code> method is also available, accepting the canonicalized MIME type name complete with type/subtype, or simply the extension name such as “xml”, “json”, “png”, etc:</p>
<pre><code> request.post(&#39;/user&#39;)
...
<p>SuperAgent will automatically serialize JSON and forms. You can setup automatic serialization for other types as well:</p>
<div class="sourceCode" id="cb24"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb24-1" title="1"><span class="va">request</span>.<span class="at">serialize</span>[<span class="st">&#39;application/xml&#39;</span>] <span class="op">=</span> <span class="kw">function</span> (obj) <span class="op">{</span></a>
<a class="sourceLine" id="cb24-2" title="2">    <span class="cf">return</span> <span class="st">&#39;string generated from obj&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb24-3" title="3"><span class="op">};</span></a>
<a class="sourceLine" id="cb24-4" title="4"></a>
<a class="sourceLine" id="cb24-5" title="5"><span class="co">// going forward, all requests with a Content-type of</span></a>
<a class="sourceLine" id="cb24-6" title="6"><span class="co">// &#39;application/xml&#39; will be automatically serialized</span></a></code></pre></div>
<p>If you want to send the payload in a custom format, you can replace the built-in serialization with the <code>.serialize()</code> method on a per-request basis:</p>
<div class="sourceCode" id="cb25"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb25-1" title="1">request</a>
<a class="sourceLine" id="cb25-2" title="2">    .<span class="at">post</span>(<span class="st">&#39;/user&#39;</span>)</a>
<a class="sourceLine" id="cb25-3" title="3">    .<span class="at">send</span>(<span class="op">{</span><span class="dt">foo</span><span class="op">:</span> <span class="st">&#39;bar&#39;</span><span class="op">}</span>)</a>
<a class="sourceLine" id="cb25-4" title="4">    .<span class="at">serialize</span>(obj <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb25-5" title="5">        <span class="cf">return</span> <span class="st">&#39;string generated from obj&#39;</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb29"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb29-1" title="1"> <span class="co">// default order</span></a>
<a class="sourceLine" id="cb29-2" title="2"> <span class="va">request</span>.<span class="at">get</span>(<span class="st">&#39;/user&#39;</span>)</a>
<a class="sourceLine" id="cb29-3" title="3">   .<span class="at">query</span>(<span class="st">&#39;name=Nick&#39;</span>)</a>
<a class="sourceLine" id="cb29-4" title="4">   .<span class="at">query</span>(<span class="st">&#39;search=Manny&#39;</span>)</a>
<a class="sourceLine" id="cb29-5" title="5">   .<span class="at">sortQuery</span>()</a>
<a class="sourceLine" id="cb29-6" title="6">   .<span class="at">then</span>(callback)</a>
<a class="sourceLine" id="cb29-7" title="7"></a>
<a class="sourceLine" id="cb29-8" title="8"> <span class="co">// customized sort function</span></a>
<a class="sourceLine" id="cb29-9" title="9"> <span class="va">request</span>.<span class="at">get</span>(<span class="st">&#39;/user&#39;</span>)</a>
<a class="sourceLine" id="cb29-10" title="10">   .<span class="at">query</span>(<span class="st">&#39;name=Nick&#39;</span>)</a>
<a class="sourceLine" id="cb29-11" title="11">   .<span class="at">query</span>(<span class="st">&#39;search=Manny&#39;</span>)</a>
<a class="sourceLine" id="cb29-12" title="12">   .<span class="at">sortQuery</span>((a<span class="op">,</span> b) <span class="kw">=&gt;</span> <span class="va">a</span>.<span class="at">length</span> <span class="op">-</span> <span class="va">b</span>.<span class="at">length</span>)</a>
<a class="sourceLine" id="cb29-13" title="13">   .<span class="at">then</span>(callback)</a></code></pre></div>
...
<div class="sourceCode" id="cb30"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb30-1" title="1"><span class="kw">var</span> key <span class="op">=</span> <span class="va">fs</span>.<span class="at">readFileSync</span>(<span class="st">&#39;key.pem&#39;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb30-2" title="2">    cert <span class="op">=</span> <span class="va">fs</span>.<span class="at">readFileSync</span>(<span class="st">&#39;cert.pem&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb30-3" title="3"></a>
<a class="sourceLine" id="cb30-4" title="4">request</a>
<a class="sourceLine" id="cb30-5" title="5">  .<span class="at">post</span>(<span class="st">&#39;/client-auth&#39;</span>)</a>
<a class="sourceLine" id="cb30-6" title="6">  .<span class="at">key</span>(key)</a>
<a class="sourceLine" id="cb30-7" title="7">  .<span class="at">cert</span>(cert)</a>
<a class="sourceLine" id="cb30-8" title="8">  .<span class="at">then</span>(callback)<span class="op">;</span></a></code></pre></div>
<div class="sourceCode" id="cb31"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb31-1" title="1"><span class="kw">var</span> ca <span class="op">=</span> <span class="va">fs</span>.<span class="at">readFileSync</span>(<span class="st">&#39;ca.cert.pem&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb31-2" title="2"></a>
<a class="sourceLine" id="cb31-3" title="3">request</a>
<a class="sourceLine" id="cb31-4" title="4">  .<span class="at">post</span>(<span class="st">&#39;https://localhost/private-ca-server&#39;</span>)</a>
<a class="sourceLine" id="cb31-5" title="5">  .<span class="at">ca</span>(ca)</a>
<a class="sourceLine" id="cb31-6" title="6">  .<span class="at">then</span>(res <span class="kw">=&gt;</span> <span class="op">{}</span>)<span class="op">;</span></a></code></pre></div>
<h2 id="parsing-response-bodies">Parsing response bodies</h2>
<p>SuperAgent will parse known response-body data for you, currently supporting <code>application/x-www-form-urlencoded</code>, <code>application/json</code>, and <code>multipart/form-data</code>. You can setup automatic parsing for other response-body data as well:</p>
<div class="sourceCode" id="cb32"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb32-1" title="1"><span class="co">//browser</span></a>
<a class="sourceLine" id="cb32-2" title="2"><span class="va">request</span>.<span class="at">parse</span>[<span class="st">&#39;application/xml&#39;</span>] <span class="op">=</span> <span class="kw">function</span> (str) <span class="op">{</span></a>
<a class="sourceLine" id="cb32-3" title="3">    <span class="cf">return</span> <span class="op">{</span><span class="st">&#39;object&#39;</span><span class="op">:</span> <span class="st">&#39;parsed from str&#39;</span><span class="op">};</span></a>
<a class="sourceLine" id="cb32-4" title="4"><span class="op">};</span></a>
<a class="sourceLine" id="cb32-5" title="5"></a>
<a class="sourceLine" id="cb32-6" title="6"><span class="co">//node</span></a>
<a class="sourceLine" id="cb32-7" title="7"><span class="va">request</span>.<span class="at">parse</span>[<span class="st">&#39;application/xml&#39;</span>] <span class="op">=</span> <span class="kw">function</span> (res<span class="op">,</span> cb) <span class="op">{</span></a>
<a class="sourceLine" id="cb32-8" title="8">    <span class="co">//parse response text and set res.body here</span></a>
<a class="sourceLine" id="cb32-9" title="9"></a>
<a class="sourceLine" id="cb32-10" title="10">    <span class="at">cb</span>(<span class="kw">null</span><span class="op">,</span> res)<span class="op">;</span></a>
<a class="sourceLine" id="cb32-11" title="11"><span class="op">};</span></a>
<a class="sourceLine" id="cb32-12" title="12"></a>
<a class="sourceLine" id="cb32-13" title="13"><span class="co">//going forward, responses of type &#39;application/xml&#39;</span></a>
<a class="sourceLine" id="cb32-14" title="14"><span class="co">//will be parsed automatically</span></a></code></pre></div>
...
<div class="sourceCode" id="cb34"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb34-1" title="1"><span class="va">req</span>.<span class="at">get</span>(<span class="st">&#39;/binary.data&#39;</span>)</a>
<a class="sourceLine" id="cb34-2" title="2">  .<span class="at">responseType</span>(<span class="st">&#39;blob&#39;</span>)</a>
<a class="sourceLine" id="cb34-3" title="3">  .<span class="at">then</span>(res <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb34-4" title="4">    <span class="co">// res.body will be a browser native Blob type here</span></a>
