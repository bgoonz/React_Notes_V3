...
<p>If you need <a href="https://nodejs.org/api/domain.html">domains</a> support, you should instead use:</p>
...
<h2 id="api">API</h2>
<p>Detailed API reference docs are available at https://www.promisejs.org/api/.</p>
...
<h4 id="promise.racearray">Promise.race(array)</h4>
<p>Returns a promise that resolves or rejects with the result of the first promise to resolve/reject, e.g.</p>
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb12-1" title="1"><span class="kw">var</span> rejected <span class="op">=</span> <span class="va">Promise</span>.<span class="at">reject</span>(<span class="kw">new</span> <span class="at">Error</span>(<span class="st">&#39;Whatever&#39;</span>))<span class="op">;</span></a>
<a class="sourceLine" id="cb12-2" title="2"><span class="kw">var</span> fulfilled <span class="op">=</span> <span class="kw">new</span> <span class="at">Promise</span>(<span class="kw">function</span> (resolve) <span class="op">{</span></a>
<a class="sourceLine" id="cb12-3" title="3">  <span class="at">setTimeout</span>(() <span class="kw">=&gt;</span> <span class="at">resolve</span>(<span class="st">&#39;success&#39;</span>)<span class="op">,</span> <span class="dv">500</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-4" title="4"><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-5" title="5"></a>
<a class="sourceLine" id="cb12-6" title="6"><span class="kw">var</span> race <span class="op">=</span> <span class="va">Promise</span>.<span class="at">race</span>([rejected<span class="op">,</span> fulfilled])<span class="op">;</span></a>
<a class="sourceLine" id="cb12-7" title="7"><span class="co">// =&gt; immediately rejected with `new Error(&#39;Whatever&#39;)`</span></a>
<a class="sourceLine" id="cb12-8" title="8"></a>
<a class="sourceLine" id="cb12-9" title="9"><span class="kw">var</span> success <span class="op">=</span> <span class="va">Promise</span>.<span class="at">resolve</span>(<span class="st">&#39;immediate success&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-10" title="10"><span class="kw">var</span> first <span class="op">=</span> <span class="va">Promise</span>.<span class="at">race</span>([success<span class="op">,</span> fulfilled])<span class="op">;</span></a>
<a class="sourceLine" id="cb12-11" title="11"><span class="co">// =&gt; immediately succeeds with `immediate success`</span></a></code></pre></div>
...
<p>e.g.</p>
<div class="sourceCode" id="cb13"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb13-1" title="1"><span class="kw">var</span> fs <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;fs&#39;</span>)</a>
<a class="sourceLine" id="cb13-2" title="2"></a>
<a class="sourceLine" id="cb13-3" title="3"><span class="kw">var</span> read <span class="op">=</span> <span class="va">Promise</span>.<span class="at">denodeify</span>(<span class="va">fs</span>.<span class="at">readFile</span>)</a>
<a class="sourceLine" id="cb13-4" title="4"><span class="kw">var</span> write <span class="op">=</span> <span class="va">Promise</span>.<span class="at">denodeify</span>(<span class="va">fs</span>.<span class="at">writeFile</span>)</a>
<a class="sourceLine" id="cb13-5" title="5"></a>
<a class="sourceLine" id="cb13-6" title="6"><span class="kw">var</span> p <span class="op">=</span> <span class="at">read</span>(<span class="st">&#39;foo.json&#39;</span><span class="op">,</span> <span class="st">&#39;utf8&#39;</span>)</a>
<a class="sourceLine" id="cb13-7" title="7">  .<span class="at">then</span>(<span class="kw">function</span> (str) <span class="op">{</span></a>
<a class="sourceLine" id="cb13-8" title="8">    <span class="cf">return</span> <span class="at">write</span>(<span class="st">&#39;foo.json&#39;</span><span class="op">,</span> <span class="va">JSON</span>.<span class="at">stringify</span>(<span class="va">JSON</span>.<span class="at">parse</span>(str)<span class="op">,</span> <span class="kw">null</span><span class="op">,</span> <span class="st">&#39;  &#39;</span>)<span class="op">,</span> <span class="st">&#39;utf8&#39;</span>)</a>
...
<div class="sourceCode" id="cb14"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb14-1" title="1"><span class="va">module</span>.<span class="at">exports</span> <span class="op">=</span> <span class="va">Promise</span>.<span class="at">nodeify</span>(awesomeAPI)</a>
<a class="sourceLine" id="cb14-2" title="2"><span class="kw">function</span> <span class="at">awesomeAPI</span>(a<span class="op">,</span> b) <span class="op">{</span></a>
<a class="sourceLine" id="cb14-3" title="3">  <span class="cf">return</span> <span class="at">download</span>(a<span class="op">,</span> b)</a>
...
<div class="sourceCode" id="cb15"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb15-1" title="1"><span class="kw">function</span> <span class="at">awesomeAPI</span>(foo<span class="op">,</span> bar<span class="op">,</span> callback) <span class="op">{</span></a>
<a class="sourceLine" id="cb15-2" title="2">  <span class="cf">return</span> <span class="at">internalAPI</span>(foo<span class="op">,</span> bar)</a>
<a class="sourceLine" id="cb15-3" title="3">    .<span class="at">then</span>(parseResult)</a>
<a class="sourceLine" id="cb15-4" title="4">    .<span class="at">then</span>(<span class="kw">null</span><span class="op">,</span> retryErrors)</a>
<a class="sourceLine" id="cb15-5" title="5">    .<span class="at">nodeify</span>(callback)</a>
