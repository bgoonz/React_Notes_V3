...
<div class="sourceCode" id="cb1"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb1-1" title="1">$ <span class="ex">npm</span> install --save extend-shallow</a></code></pre></div>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> extend <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;extend-shallow&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-2" title="2"></a>
<a class="sourceLine" id="cb2-3" title="3"><span class="at">extend</span>(<span class="op">{</span><span class="dt">a</span><span class="op">:</span> <span class="st">&#39;b&#39;</span><span class="op">},</span> <span class="op">{</span><span class="dt">c</span><span class="op">:</span> <span class="st">&#39;d&#39;</span><span class="op">}</span>)</a>
<a class="sourceLine" id="cb2-4" title="4"><span class="co">//=&gt; {a: &#39;b&#39;, c: &#39;d&#39;}</span></a></code></pre></div>
...
<a class="sourceLine" id="cb3-2" title="2"><span class="at">extend</span>(obj<span class="op">,</span> <span class="op">{</span><span class="dt">a</span><span class="op">:</span> <span class="st">&#39;b&#39;</span><span class="op">},</span> <span class="op">{</span><span class="dt">c</span><span class="op">:</span> <span class="st">&#39;d&#39;</span><span class="op">}</span>)</a>
<a class="sourceLine" id="cb3-3" title="3"><span class="co">//=&gt; {a: &#39;b&#39;, c: &#39;d&#39;}</span></a></code></pre></div>
