...
2. `info` - An object with a `componentStack` key containing [information about which component threw the error](chrome-extension://cjedbglnccaioiolemnfhjncicchinao/docs/error-boundaries.html#component-stack-traces).
